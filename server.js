...
app.post('/auth-url', (req, res) => {
  ...
  const authUrl = `https://menarinipharma--developer.sandbox.my.site.com/services/oauth2/authorize?company=Deloitte&response_type=code&client_id=${clientId}&redirect_uri=${redirectUri}&code_challenge=${code_challenge}&code_challenge_method=S256&scope=openid profile email`
